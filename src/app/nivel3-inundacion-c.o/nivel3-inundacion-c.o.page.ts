...
@Component({
  selector: 'app-nivel3-inundacion-c.o',
  templateUrl: './nivel3-inundacion-c.o.page.html',
  styleUrls: ['./nivel3-inundacion-c.o.page.scss'],
})
export class Nivel3InundacionCOPage implements OnInit {
  questions: Question[] = [
    {

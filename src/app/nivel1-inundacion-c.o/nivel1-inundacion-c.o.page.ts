...
@Component({
  selector: 'app-nivel1-inundacion-c.o',
  templateUrl: './nivel1-inundacion-c.o.page.html',
  styleUrls: ['./nivel1-inundacion-c.o.page.scss'],
})
export class Nivel1InundacionCOPage implements OnInit {
  questions: Question[] = [
    {

...
@Component({
  selector: 'app-nivel2-inundacion-c.o',
  templateUrl: './nivel2-inundacion-c.o.page.html',
  styleUrls: ['./nivel2-inundacion-c.o.page.scss'],
})
export class Nivel2InundacionCOPage implements OnInit {
  questions: Question[] = [
    {
